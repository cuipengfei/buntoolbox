...
**常用工具**: git, gh, jq, ripgrep, fd, fzf, tmux, zellij, lazygit, helix, bat, eza, delta, btop, starship, zoxide, procs, duf, bd, mihomo, openvscode-server, jdtls 等（网络: ping, ip, ss, dig, nc, socat, ssh, sshd）
